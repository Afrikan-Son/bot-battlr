...
# Project setup
Run this command to get the backend started: npx json-server --watch db.json --port 8002
In a new terminal, run npm start. This will run your React app in a new port.
